...
class Database
{
    ...
    */
    private static function connect()
    {
        ...
        $server = 'ec2-54-160-200-167.compute-1.amazonaws.com';
        $database = 'd1va5diojp9krv';
        $username = 'wioxioxyekfzoz';
        $password = '6c29da3e2fb5ef003d1de33637acc5b09d25a3bf07a3c74f01d8770c076d2311';
