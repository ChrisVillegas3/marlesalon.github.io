...
class Report extends FPDF
{
    ...
    */
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['id_usuario'])) {
            ...
            $this->addPage('LANDSCAPES', 'letter');
    ...
    */
    public function header()
    {
        ...
        $this->cell(220, 10, utf8_decode($this->title), 0, 1, 'C');
        // Se ubica la fecha y hora del servidor.
        $this->cell(20);
        $this->setFont('Arial', '', 10);
        $this->cell(220, 10, 'Fecha/Hora: '.date('d-m-Y H:i:s'), 0, 1, 'C');
        $this->cell(260, 10,'Nombre del usuario : '.utf8_decode($_SESSION['alias_usuario']), 0, 1, 'C');
