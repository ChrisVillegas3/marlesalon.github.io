...
class Database
{
    ...
    */
    private static function connect()
    {
        ...
        $server = 'ec2-107-23-76-12.compute-1.amazonaws.com';
        $database = 'd5jtsj4rh4gglg';
        $username = 'ktkgbhmtrvxlsw';
        $password = '900bb1a252dcee87f7e5803b3bc7aef53ba7877fcfb0aed990c6f31565977cdd';
