...
function openReport(id) {
    ...
    let url = SERVER + 'reports/dashboard/clientes.php';
        ...
        content += `
            <tr>
               <td>${row.nombres_cliente}</td>
                ...
                <td>
                <a onclick="openUpdate(${row.id_cliente})" class="btn-floating waves-effect pink lighten-1 tooltipped" data-tooltip="Actualizar">
                    <i class="material-icons">mode_edit</i>
                </a>
                <a onclick="openDelete(${row.id_cliente})" class="btn-floating waves-effect pink lighten-1 tooltipped" data-tooltip="Eliminar">
                    <i class="material-icons">delete</i>
                </a>
                <a onclick="openReport(${row.id_cliente})" class="btn-floating waves-effect pink darken-2 tooltipped" data-tooltip="Reporte">
        ...
        if (request.ok) {
            ...
            request.json().then(function (response) {
                ...
                if (response.status) {
                    ...
                    document.getElementById('nombres').value = response.dataset.nombres_cliente;
                    document.getElementById('apellidos').value = response.dataset.apellidos_cliente;
