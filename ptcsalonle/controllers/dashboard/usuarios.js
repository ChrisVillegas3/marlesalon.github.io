...
function openReport(usuario) {
    // Se establece la ruta del reporte en el servidor.
    let url = SERVER + 'reports/dashboard/estilistas_peticion.php?id='+ usuario;
    ...
    dataset.map(function (row) {
        ...
        content += `
            <tr>
                ...
                <td>
                    <a onclick="openUpdate(${row.id_usuario})" class="btn-floating waves-effect pink lighten-1 tooltipped" data-tooltip="Actualizar">
                        <i class="material-icons">mode_edit</i>
                    </a>
                    <a onclick="openDelete(${row.id_usuario})" class="btn-floating waves-effect  pink lighten-1 tooltipped" data-tooltip="Eliminar">
                        <i class="material-icons">delete</i>
                    </a>
                    <a onclick="openReport(${row.id_usuario})" class="btn-floating waves-effect pink darken-2 tooltipped" data-tooltip="Reporte">
